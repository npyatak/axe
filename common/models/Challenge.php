...
class Challenge extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['access_key', 'unique'],
            [['videoFile'], 'file','skipOnEmpty' => true, 'maxSize' => 1024 * 1024 * 20, 'extensions' => 'mp4,mov,m4v,mpeg,mpg', 'checkExtensionByMimeType' => false, 'tooBig' => 'Максимальный размер видео 20Мб'],
        ];
    }
