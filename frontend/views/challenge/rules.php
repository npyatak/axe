        ...
        <div class="row">
                    ...
                    <div class="cm_block">
                        ...
                        <div class="cmb_text">
                            <p>
                                ...
                                <br/>указав хэштег #AXEBEST в названии
                            </p>
                        </div>
                    </div>
                    <!-- /block -->
            ...
            <div class="main_video_news">
                <div class="rules_content">
                    ...
                    <p>01. Авторизоваться в проекте с помощью Facebook или ВКонтакте и загрузить видео своего лучшего игрового момента залитого на YouTube – указав ссылку или загрузить видео-файл (не более 20 Мб).</p>
                    <h3>или</h3>
                    ...
                    <p>
                        <ul>
                            ...
                            <li>    Постинг видео с хэштегами в ВКонтакте (<a href="">скрин</a>)</li>
                        </ul>
                    </p>-->
                    <h3><b>Модерация</b></h3>
